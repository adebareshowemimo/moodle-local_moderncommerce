...
/**
 * External API for deleting a Modern Commerce product category.
 *
...
/**
 * Delete a product category, detaching it from products.
 */
class delete_category extends external_api {
    ...
    public static function execute(int $id): array {
        ...
        return category_service::delete_category((int) $id);
    }
