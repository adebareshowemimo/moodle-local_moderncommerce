...
/**
 * Multi-course enrollment key redemption page (React + webservice driven).
 *
...
$PAGE->set_url(new moodle_url('/local/moderncommerce/redeem_multiple.php', $orderid ? ['orderid' => $orderid] : []));
