...
/**
 * Modern Commerce course review dashboard route.
 *
...
$PAGE->set_url(new moodle_url('/local/moderncommerce/admin/course_reviews.php'));
$PAGE->set_pagelayout('admin');
$PAGE->set_secondary_navigation(false);
$PAGE->set_primary_active_tab('ccpadmin');
$PAGE->set_title(course_reviews_page::title($mode, $courseid));

$shellhtml = admin_shell::create('reviewdashboard')
